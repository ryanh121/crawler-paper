...
# https://openreview.net/notes?invitation=ICLR.cc%2F2019%2FConference%2F-%2FBlind_Submission&limit=1000&offset=0
# https://openreview.net/notes?invitation=ICLR.cc%2F2019%2FConference%2F-%2FBlind_Submission&limit=1000&offset=1000
...
with open(data_path + 'cache_json_1.json', 'r') as fin:
        json_result = json.load(fin)

with open(data_path + 'cache_json_2.json', 'r') as fin:
        json_result[u'notes'].extend((json.load(fin))[u'notes'])
...
def dfs_tree(rootid, nodeid, prefix, fout, subsubpath, id2children, id2signature, id2tmdate, id2tcdate, id2content):
        ...
        if u'decision' in content:
                ...
                flag = 'review'
        elif u'withdrawal confirmation' in content:
                content_body = content[u'withdrawal confirmation']
                flag = 'withdrawal'
        else:
...
for i in range(1119, len(json_result['notes'])):
#for i in range(1119, 1120):
	print 'crawling', i
